      ...
      <div className="relative">
        {showLoader ? (
          ...
          <>
            ...
            <section className="relative flex flex-col items-center justify-center h-screen w-full p-4 md:p-10">
              <Navbar />
              <BlurText
                ...
                animateBy="words"
                direction="top"
                className="text-4xl md:text-6xl mt-32 md:mt-52 text-center"
              />
              <div className="flex flex-col md:flex-row gap-4 mt-60 md:mt-80">
                <Link href="/booking">
            ...
            <section className="relative flex flex-col items-center justify-between h-screen w-full p-4 md:p-10">
              <TextPressure
                text="Why&nbsp;Choose&nbsp;Us"
                flex={true}
                alpha={false}
            ...
            <section className="relative h-screen w-full flex flex-col justify-evenly items-center p-4 md:p-10">
