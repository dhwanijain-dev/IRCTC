...
const trains: Train[] = [
  { id: 1, name: "Express 101", type: "Superfast", duration: "6h 30m", price: 1200, model: "/train1.glb" },
  { id: 2, name: "Rajdhani", type: "Premium", duration: "5h 15m", price: 1800, model: "/train2.glb" },
  { id: 3, name: "Shatabdi", type: "Executive", duration: "4h 45m", price: 2200, model: "/train3.glb" },
];
